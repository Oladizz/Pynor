...
exports.setUserRole = (0, https_1.onCall)(async (request) => {
    ...
    if (!userId || !newRole) {
        throw new https_1.HttpsError('invalid-argument', 'The function must be called with "userId" and "newRole" arguments.');
    }
    try {
        ...
        throw new https_1.HttpsError('internal', `Failed to set role: ${error.message}`);
    }
});
